          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(children: [
                  SizedBox(width: 12,),
                  Icon(Icons.arrow_upward, color: Colors.grey,size: 12,),
                  SizedBox(width: 4,),
                  Text("20", style: AppStyle.bodyTextVerySmall(Colors.grey),),
                  SizedBox(width: 8,),
                  Icon(Icons.messenger_outline, color: Colors.grey,size: 12,),
                  SizedBox(width: 4,),
                  Text("20", style: AppStyle.bodyTextVerySmall(Colors.grey),),
                ],),
              )
